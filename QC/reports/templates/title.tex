...
\titlegraphic{
  \includegraphics[width = \textwidth, keepaspectratio=true]{\imagedir/4_Color_Logo_CB.png}
}
...
{
  \centering
  \usebackgroundtemplate{\includegraphics[trim = 0 0 0 300, clip,width=\paperwidth,keepaspectratio]{\imagedir/tof-2006-011}}
  \begin{frame}
    \maketitle
  \end{frame}
}
